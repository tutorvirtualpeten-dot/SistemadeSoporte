...
const { getUsers, createUser, deleteUser, updateUser, getDashboardStats, getAgents, searchUsers } = require('../controllers/adminController');
...
router.get('/users/search', agentOrAdmin, searchUsers);
